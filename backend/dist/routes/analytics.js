...
router.get('/volume', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error fetching volume analytics:', error);
        res.status(500).json({
            success: false,
...
router.get('/oracle', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error fetching oracle analytics:', error);
        res.status(500).json({
            success: false,
...
router.get('/financial', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error fetching financial analytics:', error);
        res.status(500).json({
            success: false,
